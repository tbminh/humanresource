    ...
    <div class="right">
        ...
        <div class="right__form">
            ...
            <form action="" method="post" class="form__login">
                ...
                <input type="password" name="admin_pass" placeholder="Nhập vào mật khẩu" required
                       class="login__input">
...
<?php
    if(isset($_POST['admin_login'])){
        ...
        $get_admin = "select * from admins where admin_email='$admin_email' AND admin_pass='$pass_md5'";
