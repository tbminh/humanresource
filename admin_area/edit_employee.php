...
<?php
    if(isset($_POST['update'])){
        ...
        $update_emp = "update employee set employee_id='$idd',full_name='$name',id_level='$level',id_position='$pos',id_schedule='$sc',email='$email',address='$address',phone='$phone',sex='$sex',birthday='$birthday' where id='$id'";
        $run_emp = mysqli_query($conn,$update_emp);

        if($run_emp){
            echo "<script>alert('KPI đã được chỉnh sửa thành công')</script>";
