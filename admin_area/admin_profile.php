                ...
                <div class="card card-primary card-outline" style="border-top: 3px solid #007bff;">
                    <div class="card-body box-profile text-center" style="box-shadow: 0 0 1px rgb(0 0 0 / 13%), 0 1px 3px rgb(0 0 0 / 20%); margin-bottom: 1rem;">
                            <span class="profile-picture">
                                <img class="editable img-responsive" alt=" Avatar" id="avatar2" style="margin-left: 0px;"
                                    src="https://png.pngtree.com/png-vector/20190501/ourmid/pngtree-users-icon-design-png-image_1014936.jpg" style="width:100px; height:100px;">
                            </span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <br/><label for="">Tên tài khoản:</label>
                                <input type="text" name="account" class="form-control" value="<?php echo $account;?>" disabled>
                            </div>
