...
if (isset($_POST['update'])) {
    ...
    if ($old == "" || $new == "" || $confirm == "") {
        ...
        $update_ship = "update users set pass='$new_md5' where id='$id'";
